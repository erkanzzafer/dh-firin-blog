...
<head>
  ...
  <link rel="stylesheet" href="{{asset('/back/jquery-ui-1.13.2/jquery-ui.min.css')}}">
  <link rel="stylesheet" href="{{asset('/back/jquery-ui-1.13.2/jquery-ui.structure.min.css')}}">
  <link rel="stylesheet" href="{{asset('/back/jquery-ui-1.13.2/jquery-ui.theme.min.css')}}">

  <link rel="stylesheet" href="{{asset('/back/toastr/ijabo.min.css')}}">
  <link rel="stylesheet" href="{{asset('/back/jquery-ui-1.13.2/jquery-ui.min.css')}}">
  <link rel="stylesheet" href="{{asset('/back/jquery-ui-1.13.2/jquery-ui.structure.min.css')}}">
  <link rel="stylesheet" href="{{asset('/back/jquery-ui-1.13.2/jquery-ui.theme.min.css')}}">
...
@include('back.inc.admin-sidebar')  <!-- Content Wrapper. Contains page content -->
...
<script src="{{asset('/back/jquery-ui-1.13.2/jquery-ui.min.js')}}"></script>
<script src="{{asset('/back/toastr/jquery-3.6.0.min.js')}}"></script>
<script src="{{asset('/back/toastr/ijabo.min.js')}}"></script>

<script src="{{asset('/back/jquery-ui-1.13.2/jquery-ui.min.js')}}"></script>
<script src="{{asset('/back/ijabo/jquery.ijaboViewer.min.js')}}"></script>
@stack('scripts')
@livewireScripts
<script>
