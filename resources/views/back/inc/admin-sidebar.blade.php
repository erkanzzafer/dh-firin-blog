    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('admin.allMenu')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tüm Menüler</p>
                </a>
              </li>
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('admin.HomeContent')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>İçerik Ayarlar</p>
                  </a>
                </li>
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('admin.sube')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Şube Ekle</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{route('admin.genelAyarlar')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Genel Ayarlar</p>
                    </a>
                  </li>
